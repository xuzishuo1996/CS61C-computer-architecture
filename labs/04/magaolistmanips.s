...
map:
	...
	add	t0, x0, x0	# t0 is a counter   t0 = 0
...
mapLoop:
  ...
  lw t1, 0(s0)    # t1 = pointer to the array
	lw t2, 4(s0)		# load the size of the node's array into t2

	#add	t1, t1, t0		# offset the array address by the count
  slli t3, t0, 2  #offset need to *4, count by bytes    t1 = offset of bytes of the array members
  add t4, t1, t3
  ...
  #addi a0, s0, 8   # load the address of the next node into a0 (My Question: why is wrong?: this just add 8 to the address of the first array.)
  lw a0, 8(s0)
	#lw	a1, 0(s1)		# put the address of the function back into a1 to prepare for the recursion
  add a1, s1, x0

	jal 	map			# recurse   # = jal ra, map
  # j map       # doesn't work
